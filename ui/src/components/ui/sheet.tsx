...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-background p-6 shadow-xl transition-transform duration-300 ease-[cubic-bezier(0.32,0.72,0,1)]",
  {
    variants: {
      side: {
        ...
        right:
          "inset-y-0 right-0 h-full w-80 border-l translate-x-full data-[state=open]:translate-x-0",
      },
    },
    defaultVariants: {
      side: "right",
